"""
Taken from https://github.com/jandersson/revenant
Preserved here only for initial reference.
"""
import re
import html
...
def test():
    ...
    test_file = pathlib.Path("line_log.xml")
